...
void gdipImage::aniRender(HDC hdc, int destX, int destY, animation * ani)
{
	//gdiFrameRender(hdc, destX, destY, ani->getFramePos().x/ ani->getFrameWidth(), ani->getFramePos().y/ ani->getFrameHeight());
	gdiRender(hdc, destX, destY, ani->getFramePos().x, ani->getFramePos().y , ani->getFrameWidth(), ani->getFrameHeight());
