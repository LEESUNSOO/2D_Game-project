...
//=============================================================
	...
	void render(HDC hdc, int destX, int destY, float sourX, float sourY, float sourWidth, float sourHeight);
...
//=============================================================
	...
	void stretchRender(HDC hdc, int destX, int destY, float sourX, float sourY, float sourWidth, float sourHeight, float scale = 1.0f);
