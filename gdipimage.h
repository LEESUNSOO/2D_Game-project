...
//========================================================================================================================================================
	...
	inline int getMaxFrameX()const { return _gdiInfo->maxFrameX; }
	inline void setMaxFrameX(int frameX) { _gdiInfo->maxFrameX = frameX; }
	inline int getMaxFrameY()const { return _gdiInfo->maxFrameY; }
	inline void setMaxFrameY(int frameY) { _gdiInfo->maxFrameY = frameY; }

	inline int getFrameWidth()const { return _gdiInfo->frameWidth; }
	inline int getFrameHeight()const { return _gdiInfo->frameHeight; }

	inline int getWidth()const { return _gdiInfo->width; }
	inline int getHeight()const { return _gdiInfo->height; }
